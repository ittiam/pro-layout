  ...
  theme: [
    {
      ...
      less: () => import('@/themes/deep-blue/index.less')
    },
    {
      name: '星空蓝',
      key: 'star-blue',
      ...
      less: () => import('@/themes/star-blue/index.less')
    },
    {
      name: 'WPG红',
      key: 'wpg-red',
      ...
      less: () => import('@/themes/wpg-red/index.less')
    },
    {
      name: '阳光橙',
      key: 'sunny-orange',
      ...
      less: () => import('@/themes/sunny-orange/index.less')
    },
    {
      name: '海洋蓝',
      key: 'sea-blue',
      ...
      less: () => import('@/themes/sea-blue/index.less')
    },
    {
      name: '骑士黑',
      key: 'knight-black',
      ...
      less: () => import('@/themes/knight-black/index.less')
    },
    {
      name: '晴空蓝',
      key: 'sunny-blue',
      ...
      less: () => import('@/themes/sunny-blue/index.less')
    },
    {
      name: '玉石白',
      key: 'stone-white',
      ...
      less: () => import('@/themes/stone-white/index.less')
    },
    {
      name: '罗兰紫',
      key: 'roland-purple',
      ...
      less: () => import('@/themes/roland-purple/index.less')
    }
  ]
};
