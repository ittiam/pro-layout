 ...
 * ]
 **/
import Menu from '@/components/Menu/node_modules/ant-design-vue/es/menu';
import Icon from '@/components/Menu/node_modules/ant-design-vue/es/icon';
...
export default {
  ...
  methods: {
    ...
    renderSubMenu: function(h, menu, pIndex, index) {
      var this2_ = this;
      var subItem = [h('span', { slot: 'title' }, [this.renderIcon(h, menu.icon), h('span', [menu.name])])];
      var itemArr = [];
